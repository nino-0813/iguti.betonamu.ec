...
const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <header className="sticky top-0 z-50 w-full min-w-[320px] bg-white border-b border-gray-200 shadow-sm overflow-x-hidden">
      {/* Top Main Header */}
      <div className="max-w-[1500px] mx-auto px-3 sm:px-4 md:px-8 py-2 sm:py-3 flex items-center gap-2 sm:gap-4 md:gap-6 w-full">
        {/* Logo */}
        <div 
          onClick={onGoHome}
